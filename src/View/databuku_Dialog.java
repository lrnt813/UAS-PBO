 ...
 * @author laure
 */
public class databuku_Dialog extends javax.swing.JDialog {

    /**
     * Creates new form dataBuku_Dialog
     */
    int xx, xy;
    private BukuDialog bukuModel;
    ...
    public databuku_Dialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        bukuModel = new BukuDialog();
        setTableModel(bukuModel.getBukuTableModel());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(databuku_Dialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                databuku_Dialog dialog = new databuku_Dialog(new javax.swing.JFrame(), true);
    ...
    private void searchData() {
        DefaultTableModel model = bukuModel.searchBuku(search_TextField.getText());
        riwayat_Table.setModel(model);
    }
    ...
    private void pilihData(){
        ...
        idBuku = riwayat_Table.getValueAt(row, 0).toString();
        judulBuku = riwayat_Table.getValueAt(row, 1).toString();
        pengarangBuku = riwayat_Table.getValueAt(row, 2).toString();
        penerbitBuku = riwayat_Table.getValueAt(row, 3).toString();
